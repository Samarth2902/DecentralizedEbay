...
$("#listItem").click(function() {
  ...
  var EcommerceStore = web3.eth.contract();
  let product = $('EcommerceStore').Product;
  Product.name.set($("#product-name").val());
  Product.auctionEndTime.set($("#product-auction-end").val());
  Product.startPrice.set($("#product-price").val());
  Product.id.set($("#product-id").val());
  Product.imageLink.set($("#product-image").val());
